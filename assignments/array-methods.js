...
// Problem 1
//Individuals who donated an amount greater than or equal to $250 should be recognized in the agenda as "VIP Contributors". Take the data and return the number of VIP contributors.
let vipContributors = runners.filter(runner => runner.donation >= 250);
console.log(vipContributors.length, vipContributors);
